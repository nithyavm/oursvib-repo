...
class WebmasterSectionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $WebmasterSection->billing_status = $request->billing_status;
        $WebmasterSection->additional_fee_status = $request->additional_fee_status;
        $WebmasterSection->activity_status = $request->activity_status;
        $WebmasterSection->package_status = $request->package_status;
        $WebmasterSection->capacity_status = $request->capacity_status;
        $WebmasterSection->ammenities_status = $request->ammenities_status;
        $WebmasterSection->description_status = $request->description_status;
