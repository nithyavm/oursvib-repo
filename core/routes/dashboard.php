...
// Sections
Route::any('/{webmasterId}/category-create', [CategoryController::class, 'create'])->name('category-createcreate');
...
Route::get('/getbooking', [CategoriesController::class, 'getBooking'])->name('getBooking');
Route::get('/getbilling', [CategoriesController::class, 'getBilling'])->name('getBilling');
Route::get('/getsubcategory', [CategoriesController::class, 'getSubCategory'])->name('getSubCategory');
Route::get('/getparent', [CategoriesController::class, 'getParent'])->name('getParent');
