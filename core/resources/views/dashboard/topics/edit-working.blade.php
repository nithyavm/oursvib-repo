...
@if($WebmasterSection->additional_fee_status)
                        ...
                        <span class="title_text">Additional Fees</span>
                    </h3>
                    <fieldset>
                        <legend>
                            <span class="step-heading">Additional Fees</span>
                            <span class="step-number">Step 2 / 6</span>
                        </legend>
                ...
                <h3>
                    ...
                    <fieldset><legend>
                            <span class="step-heading">Activity</span>
                            <span class="step-number">Step 3 / 6</span>
                        </legend> 
                ...
                <h3>
                    ...
                    <fieldset><legend>
                            <span class="step-heading">Package </span>
                ...
                <h3>
                    ...
                    <fieldset> <legend>
                            <span class="step-heading">Capacity</span>
                ...
                <h3>
                        <span class="icon"><i class="ti-email"></i></span>
                        <span class="title_text">Ammenities and Facilities</span>
                    </h3>
                    <fieldset> <legend>
                            <span class="step-heading">Ammenities and Facilities</span>
                            <span class="step-number">Step 6 / 6</span>
                        </legend> 
