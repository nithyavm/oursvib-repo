...
@section('content')
    <div class="padding">
        <div class="box">
                              ...
                              @if($WebmasterSection->title_en == "Listings")
                                @foreach ($fatherSections as $fatherSection)
                                    ...
                                    @foreach ($fatherSection->fatherSections as $subFatherSection)
                                        ...
                                        ?>
                                        <!-- <option
                                            value="{{ $subFatherSection->id  }}">{!! $ftitle !!} {!! $t_arrow !!} {!! $fstitle !!}</option>
                                            -->
                                            @foreach ($subFatherSection->fatherSections as $subFatherSection1) 
                                                ...
                                                ?>
                                                <!-- <option
                                                    value="{{ $subFatherSection1->id  }}" > {!! $ftitle !!} {!! $t_arrow !!} {!! $fstitle !!}{!! $t_arrow !!} {!! $fsstitle !!}</option>
                                                ...
                                                ?>
                                                <option
                                                    value="{{ $subFatherSection2->id  }}" > {!! $ftitle !!}{!! $t_arrow !!}{!! $fstitle !!}{!! $t_arrow !!}{!! $fsstitle !!}{!! $t_arrow !!}{!! $fssstitle !!}</option>
         ...
         <div class="form-group row by-activity">
         <h4>Strategic Location & Nearby  </h4>
                        </div>

                        <div class="row mar-bot">
                                <div class="col-md-1">
                                    <div class="round-but">1</div>
                                </div>
                                <div class="col-md-6">
                                {!! Form::text('location_nearby_name1','', array('placeholder' => 'Name','class' => 'form-control','id'=>'discount_price')) !!}
                                ...
                                <!-- {!! Form::number('location_nearby_dis1','', array('placeholder' => 'Distance(in km)', ' class' => 'form-control','id'=>'discount_price')) !!} -->
                                        <input type="number" step="0.01" class="form-control" name="location_nearby_dis1" min="0" max="10" placeholder="Distance(in km)" >
                            ...
                            <div class="row mar-bot">
                                <div class="col-md-1">
                                    <div class="round-but">2</div>
                                </div>
                                <div class="col-md-6">
                                {!! Form::text('location_nearby_name2','', array('placeholder' => 'Name','class' => 'form-control','id'=>'discount_price')) !!}
                                 
                                </div>
                                <div class="col-md-5">
                                <div class="input-group km-only"> 
                                        <input type="number" step="0.01" min="0" max="10" class="form-control" name="location_nearby_dis2nd" placeholder="Distance(in km)" >
                                        <span class="input-group-addon ">KM</span>
                                    </div>
                            ...
                            <div class="row mar-bot">
                                <div class="col-md-1">
                                    <div class="round-but">3</div>
                                </div>
                                <div class="col-md-6">
                                {!! Form::text('location_nearby_name3','', array('placeholder' => 'Name','class' => 'form-control','id'=>'discount_price')) !!}

                                   
                                </div>  
                                <div class="col-md-5">
                                <div class="input-group km-only">
                                        <input type="number"  step="0.01" class="form-control" name="location_nearby_dis3" min="0" max="10" placeholder="Distance (in km)" >
                                       <span class="input-group-addon ">KM</span>
                                    </div>
