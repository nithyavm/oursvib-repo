        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                ...
                @if($WebmasterSection->additional_fee_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_10 }}" href data-toggle="tab" data-target="#tab_additional">
                    <span class="text-md"><i class="material-icons">
                            &#xe8e5;</i> Additional Fees</span>
                        </a>
                    </li>
                @endif
                @if($WebmasterSection->activity_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_11 }}" href data-toggle="tab" data-target="#tab_activity">
                    <span class="text-md"><i class="material-icons">
                            &#xe8e5;</i> Activity</span>
                        </a>
                    </li>
                ...
                @if($WebmasterSection->package_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_12 }}" href data-toggle="tab" data-target="#tab_package">
                    <span class="text-md"><i class="material-icons">
                            &#xe8e5;</i> Package</span>
                        </a>
                    </li>
                ...
                @if($WebmasterSection->capacity_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_13 }}" href data-toggle="tab" data-target="#tab_capacity">
                    <span class="text-md"><i class="material-icons">
                            &#xe8e5;</i> Capacity</span>
                        </a>
                    </li>
                ...
                @if($WebmasterSection->ammenities_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_14 }}" href data-toggle="tab" data-target="#tab_ammenities">
                    <span class="text-md"><i class="material-icons">
                            &#xe8e5;</i> Ammenities</span>
                        </a>
                    </li>
            ...
            <div class="tab-content clear b-t">
                ...
                icons: {
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        <h3 id="signupform-h-3" tabindex="-1" class="title current"></h3>
             <fieldset id="signupform-p-3" role="tabpanel" aria-labelledby="signupform-h-3" class="body current" aria-hidden="false" style="">
                           <legend>
                               <span class="step-heading">Basic Details </span>
                               <span class="step-number">Step 1/ 6</span>
                           </legend>
                           @endif
                                    ...
                                    <select name="section_id[]" id="section_id" class="form-control select2-multiple"
                                        ...
                                        @foreach ($fatherSections as $fatherSection)
                                            ...
                                            @foreach ($fatherSection->fatherSections as $subFatherSection)
                                                ...
                                                ?>
                                                <!-- <option
                                                    value="{{ $subFatherSection->id  }}" {{ (in_array($subFatherSection->id,$categories)) ? "selected='selected'":""  }}> {!! $ftitle !!} {!! $t_arrow !!} {!! $fstitle !!}</option> -->
                                                ...
                                                ?>
                                                <!-- <option
                                                    value="{{ $subFatherSection1->id  }}" {{ (in_array($subFatherSection1->id,$categories)) ? "selected='selected'":""  }}> {!! $ftitle !!} {!! $t_arrow !!} {!! $fstitle !!}{!! $t_arrow !!} {!! $fsstitle !!}</option> -->
                                                ...
                                                ?>
                                                <option
                                                    value="{{ $subFatherSection2->id  }}" {{ (in_array($subFatherSection2->id,$categories)) ? "selected='selected'":""  }}> {!! $ftitle !!}{!! $t_arrow !!}{!! $fstitle !!}{!! $t_arrow !!}{!! $fsstitle !!}
                                                    {!! $t_arrow !!} {!! $fssstitle !!}</option>
                        ...
                        <div class="col-sm-10">  
                            <select class="form-control select2-multiple" id="booking" 
            ...
            <label for="billing_type" class="col-sm-2 form-control-label">Billing Type</label>
                <div class="col-sm-10">  
                    <select class="orm-control select2-multiple" id="billing" ui-jp="select2"
                                                ui-options="{theme: 'bootstrap'}" required>
                    <option selected>BillingType</option>
                    </select>
                </div>
         </div>       
         <div class="form-group row">
...
<input type="hidden" name="section_id" id="book_id" />
                ...
                @include('dashboard.topics.tabs.description')                                
                ...
                @include('dashboard.topics.tabs.billing')
            </div>
        </div>
    </div>
@endsection
