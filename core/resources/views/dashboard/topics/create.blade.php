            ...
            onImageUpload: function(files, editor, welEditable) {
                ...
                <h4>Strategic Location & Nearby  </h4>
                               ...
                               <div class="form-group row mar-bot">
                                       ...
                                       <div class="col-md-6">
                                       {!! Form::text('strategic_location1','', array('placeholder' => 'Name','class' => 'form-control','id'=>'discount_price')) !!}
                                       ...
                                       <!-- {!! Form::number('location_nearby_dis1','', array('placeholder' => 'Distance(in km)', ' class' => 'form-control','id'=>'discount_price')) !!} -->
                                               <input type="number" step="0.01" class="form-control" name="near_by1" min="0" max="10" placeholder="Distance(in km)" >
                                   ...
                                   <div class=" form-group row mar-bot">
                                       ...
                                       <div class="col-md-6">
                                       {!! Form::text('strategic_location2','', array('placeholder' => 'Name','class' => 'form-control','id'=>'discount_price')) !!}
                                        
                                       </div>
                                       <div class="col-md-5">
                                       <div class="input-group km-only"> 
                                               <input type="number" step="0.01" min="0" max="10" class="form-control" name="near_by2" placeholder="Distance(in km)" >
                                               <span class="input-group-addon ">KM</span>
                                           </div>
                                   ...
                                   <div class=" form-group row mar-bot">
                                       ...
                                       <div class="col-md-6">
                                       {!! Form::text('strategic_location3','', array('placeholder' => 'Name','class' => 'form-control','id'=>'discount_price')) !!}
       
                                          
                                       </div>  
                                       <div class="col-md-5">
                                       <div class="input-group km-only">
                                               <input type="number"  step="0.01" class="form-control" name="near_by3" min="0" max="10" placeholder="Distance (in km)" >
                                              <span class="input-group-addon ">KM</span>
                                           </div>
