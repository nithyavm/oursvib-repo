                    ...
                    <table class="table table-bordered m-a-0">
                        ...
                        @foreach($Sections as $Section)
                            ...
                            @foreach($Section->fatherSections as $subSection)
                                ...
                                @foreach($subSection->fatherSections as $subSection1)
                                <?php
                                if ($subSection1->$title_var != "") {
                                    $title = $subSection1->$title_var;
                                } else {
                                    $title = $subSection1->$title_var2;
                                }
                                ?>
                              <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $subSection1->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]',$subSection1->id, array('class' => 'form-control row_no')) !!}
                                        </label>
                                    </td>
                                    <td class="h6">  
                                        @if($subSection1->photo !="")
                                            <div class="pull-right">
                                                <img src="{{ asset('uploads/sections/'.$subSection1->photo) }}"
                                                     style="height: 30px" alt="{{ $title }}">
                                            </div>
                                        @endif
                                     <img
                                            src="{{ asset('assets/dashboard/images/treepart_'.@Helper::currentLanguage()->direction.'.png') }}"
                                            class="submenu_tree"> <img
                                            src="{{ asset('assets/dashboard/images/treepart_'.@Helper::currentLanguage()->direction.'.png') }}"
                                            class="submenu_tree">
                                        {!! Form::text('row_no_'.$subSection1->id,$subSection1->row_no, array('class' => 'form-control row_no','id'=>'row_no')) !!}
                                        @if($subSection1->icon !="")
                                            <i class="fa {!! $subSection1->icon !!} "></i>
                                        @endif
                                        {!! $title   !!}</td>
                                    <td class="text-center">
                                        {!! $subSection1->visits  !!}
                                    ...
                                    <td class="text-center">
                                        <i class="fa {{ ($subSection1->status==1) ? "fa-check text-success":"fa-times text-danger" }} inline"></i>
                                    </td>

                                    <td class="text-center">
                                        <a class="btn btn-sm info"
                                           href="{{ Helper::categoryURL($subSection1->id) }}"
                                           data-toggle="tooltip" data-original-title="{{ __('backend.viewDetails') }}"
                                           target="_blank">
                                            <i class="material-icons">&#xe8f4;</i>
                                        </a>
                                        ...
                                        @if(@Auth::user()->permissionsGroup->edit_status)
                                            <a class="btn btn-sm success"
                                               href="{{ route("categoriesEdit",["webmasterId"=>$WebmasterSection->id,"id"=>$subSection1->id]) }}"
                                               data-toggle="tooltip" data-original-title="{{ __('backend.edit') }}">
                                                <i class="material-icons">&#xe3c9;</i>
                                            </a>
                                        @endif
                                        @if(@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning" type="button"
                                                    onclick="DeleteCategory('{{ $subSection1->id }}')" data-toggle="tooltip"
                                                    data-original-title="{{ __('backend.delete') }}">
                                                <i class="material-icons">&#xe872;</i>
                                            </button>
                                        @endif
                                ...
                                <!--Second level sub category started -->
                                @foreach($subSection1->fatherSections as $subSection2)
                                <?php
                              ...
                              <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $subSection2->id }}"><i
                                                class="dark-white"></i>
                                    ...
                                    <td class="h6">  
                                     ...
                                     <img
                                            ...
                                            src="{{ asset('assets/dashboard/images/treepart_'.@Helper::currentLanguage()->direction.'.png') }}"
                                            class="submenu_tree">
                                        {!! Form::text('row_no_'.$subSection2->id,$subSection2->row_no, array('class' => 'form-control row_no','id'=>'row_no')) !!}
                                        @if($subSection2->icon !="")
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm info"
                                           href="{{ Helper::categoryURL($subSection2->id) }}"
                                           data-toggle="tooltip" data-original-title="{{ __('backend.viewDetails') }}"
                                           target="_blank">
                                            <i class="material-icons">&#xe8f4;</i> 
                                        </a>
                                        ...
                                        @if(@Auth::user()->permissionsGroup->edit_status)
                                            <a class="btn btn-sm success"
                                               href="{{ route("categoriesEdit",["webmasterId"=>$WebmasterSection->id,"id"=>$subSection2->id]) }}"
                                               data-toggle="tooltip" data-original-title="{{ __('backend.edit') }}">
                                                <i class="material-icons">&#xe3c9;</i>
                                            </a>
                                        @endif
                                        @if(@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning" type="button"
                                                    onclick="DeleteCategory('{{ $subSection2->id }}')" data-toggle="tooltip"
                                                    data-original-title="{{ __('backend.delete') }}">
                                                <i class="material-icons">&#xe872;</i>
                                            </button>
                                        @endif
